...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    {
        sprintf(frameName1, "pulled-gem-mouse-%d.png", i);
    ...
    {
        sprintf(frameName2, "diamond-%d.png", i);
        diamondAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(frameName2));
    }
